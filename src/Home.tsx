      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start relative z-10">
        <header className="flex flex-col gap-2 items-start max-w-xl">
          ...
          <p className="text-medium mt-0">
            Effortless Authentication for Modern Apps!
          </p>
        </header>
        <section className="flex flex-col gap-4 mx-auto max-w-xl">
          <p className="text-sm text-gray-300 mb-4">
            This example app allows users to create a user account. When a user
            creates an account, their data is automatically synced to your Neon
            database. Create an account via the sign up button above to try it
            yourself.
          </p>
          <p className="text-sm text-gray-300 mb-4">
            Neon Auth connects{' '}
            ...
            to your Neon database, automatically synchronizing user profiles so
            that you own your auth data. Access your user data directly in your
            database environment, with no custom integration code needed.
          </p>
        </section>
